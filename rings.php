  ...
  <button data-collapse-toggle="mega-menu-full" type="button" class="inline-flex items-center px-52 w-10 h-10  text-sm text-gray-500 rounded-lg md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mega-menu-full" aria-expanded="false">
      ...
      <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h15M1 7h15M1 13h15"/>
              ...
              <li>
                <a href="new.html" class="  block  text-gray-500  text-sm mr-8">Contact Us</a>
            </li>
          </ul>
...
<br>
 ...
 <form name="filter" class="flex justify-center">&nbsp;
  ...
  &nbsp;&nbsp;
  <input type="submit" class="bg-black text-white h-10 text-sm text-center w-32" value="FILTER">
</form>
<br><br>
...
$sql="SELECT * FROM produits where categorie='rings'";
...
echo'
<a  class="max-w-[300px] mx-auto">
                    <div class="w-full max-w-sm aspect-square">
                        <img src="images/'.$image.'"  class="w-full h-full rounded-xl">
                    </div>
                    <div class="mt-5 flex items-center justify-between">
                        <div class="">
                            <h6 class="font-medium text-xl leading-8 text-black mb-2">'.$name.'</h6>
                            <h6 class="font-semibold text-xl leading-8 text-indigo-600">'.$price.'$</h6>
                        </div>
                        <button name="addtocart" value="'.$ref.'"
