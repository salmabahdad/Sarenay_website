...
<div class="relative  h-36" >
    ...
    <?php 
    session_start();
    if(isset($_SESSION["user_email"])){//onClick="afficherdropdown()"
      echo'<a href="#" id="user" name="user" class="  font-thin mt-2.5 text-sm hover:text-gray-600  text-gray-400"><img class="h-4 mt-0 ml-auto"src="images/user.png"></a>&nbsp;&nbsp;';
      echo'<button id="buttondrop" name="user" class="user font-thin text-xs hover:text-gray-600 text-gray-400 pt-0" onclick="toggleDropdown()">'.$_SESSION["user_email"].'</button>';
    }
    else{
      echo'<a href="login.php" id="user" name="user" class="  font-thin mt-2.5 text-sm hover:text-gray-600  text-gray-400"><img class="h-4 mt-0 ml-auto"src="images/user.png"></a>&nbsp;&nbsp;';
    }
...
<nav>
  ...
  <button data-collapse-toggle="mega-menu-full" type="button" class="inline-flex items-center px-52 w-10 h-10  text-sm text-gray-500 rounded-lg md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mega-menu-full" aria-expanded="false">
      ...
      <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h15M1 7h15M1 13h15"/>
              ...
              <li>
                  <a href="home.html" class="  block  text-gray-500  text-sm "  aria-current="page">Home</a>
              </li>
              <li>
              ...
              <li>
                  <a href="new.html" class="  block  text-gray-500  text-sm mr-8">News</a>
              </li>
              <li>
                <a href="contactus.html" class="  block  text-gray-500  text-sm mr-8">News</a>
            </li>
          </ul>
  ...
  <div class=" h-full flex justify-center items-start">
    <div class="max-w-screen-lg mx-auto">
      <a href="lastring.html"><img src="images/star.jpg" class="h-full w-auto" alt="Star image"></a>
    </div>
  </div>

  <div class=" mt-2">
    <p style="text-align:center;" id="animated-text" class="fonts text-black text-3xl animate-pulse">DIVINE RADIANCE</p>
  </div> 
  <div class="">
    <p style="text-align:center;" class="font-extralight text-gray-500 text-base">
      The latest Sarenay ring, captures the essence of timeless elegance. 
    </p>
  </div>
  <div class="mt-3">
    <a href="lastring.html">
    <p style="text-align:center; ;" class=" animate-bounce font-extralight  hover:text-gray-950 text-gray-500 text-sm">
...
<div class="bg-gray-50  "><br>
  <h2 class="text-lg font-semibold text-center ">ORDER BY CATEGORY</h2>
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <h2 class="text-lg font-light text-sm text-center ">A daring design coupled with uncomparable craftsmanship.
    </h2>
    <div class="items-center">
    
    <div class="w-11 mx-auto border-b border-gray-800 my-4"></div>
</div>
    <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-0">
      ...
      <div class="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
        <div class="group relative">
          <div class="relative h-80 w-full overflow-hidden  bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 sm:h-64">
            <img src="images/uh.jpg"  class="h-full w-full object-cover object-center">
          </div>
        ...
        <div class="group relative">
          <div class="relative h-80 w-full overflow-hidden  bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 sm:h-64">
            <img src="images/earrings.jpg" class="h-full w-full object-cover object-center">
          </div>
          <h3 class="mt-6 text-sm text-gray-500 text-center">
        ...
        <div class="group relative">
          <div class="relative h-80 w-full overflow-hidden  bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 sm:h-64">
            <img src="images/ringgolden.jpg" alt="Collection of four insulated travel bottles on wooden shelf." class="h-full w-full object-cover object-center">
          </div>
          <h3 class="mt-6 text-sm text-gray-500 text-center">
            <a href="rings.php">
              <span class="absolute inset-0"></span>
...
<div class="flex justify-between m-10 items-center p-10">
  <div class="w-1/2 pr-5">
    <h2 class="text-xl font-mono">Glamour Curated by You</h2>
    <p class="mt-2 text-black font-extralight">Embrace the art of adornment with your jewelry choices.</p>
  </div>
  <div class="w-1/2 pl-16">
    <img src="images/hand.jpg" alt="Your Image" class="hand  w-auto md:h-full ">
  </div>
</div>


<!-- component -->
<div id="services" class="section relative pt-0 pb-8 md:pt-16 md:pb-0 bg-white">
  <div class="container xl:max-w-6xl mx-auto px-4">
      <!-- Heading start -->
      <header class="text-center mx-auto mb-12 lg:px-20">
          <h2 class="text-lg leading-normal mb-2 font-semibold text-black">OUR SERVICES</h2>
          <div class="w-11 mx-auto border-b border-gray-800 my-4"></div>
      ...
      <div class="flex flex-wrap flex-row -mx-4 text-center">
          <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
              ...
              <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                  <div class="inline-block text-gray-900 mb-4">
                      <!-- icon -->
                      <img src="images/service-client.png" class="h-8">
                  </div>
                  <h3 class="text-base leading-normal mb-2 font-semibold text-black">Sarenay at your service</h3>
                  <p class="text-gray-500">Commitment to understanding your needs and exceeding expectations, we stand ready to serve you.</p>
              </div>
              <!-- end service block -->
          </div>
          <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInUp;">
              ...
              <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                  <div class="inline-block text-gray-900 mb-4">
                      <!-- icon -->
                      <img src="images/livraison-rapide.png" class="h-10">
                  </div>
                  <h3 class="text-base leading-normal mb-2 font-semibold text-black">Free shipping</h3>
                  <p class="text-gray-500">We believe in making your shopping experience as seamless and convenient as possible.</p>
              </div>
              <!-- end service block -->
          </div>
          <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInUp;">
              ...
              <div class="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                <div class="inline-block text-gray-900 mb-4">
                  <!-- Icon representing client service or customer support -->
                  <img src="images/centre.png" class="h-9 pt-0">
              </div>
              
                  <h3 class="text-base leading-normal mb-2 font-semibold text-black">After-sales service</h3>
                  <p class="text-gray-500">At Sarenay, our commitment to you doesn't end at the point of sale.</p>
              </div>
              <!-- end service block -->
