...
if (!$conn) {
    ...
    $string=$_POST['inputi'];
    $SQL1="SELECT * FROM produits WHERE categorie='$string' OR name='$string'";
...
echo' 
  ...
  <button type="submit" name="addtocart" value="'.$ref.'" class="flex w-full items-center justify-center rounded-md hover:bg-gray-500 bg-black px-5 py-2.5 text-center text-sm font-medium text-white  focus:outline-none focus:ring-4">
