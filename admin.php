...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Email et mot de passe de l'administrateur
    $admin_email = "admin@gmail.com";
    $admin_password = "admin123";

    if ($email == $admin_email && $password == $admin_password) {
        $_SESSION['admin_connected'] = $email;
...
?>
   ...
   <div class="flex flex-wrap  h-10 justify-between items-center   mx-auto max-w-screen-xl p-4  relative top-0">
     <button data-collapse-toggle="mega-menu-full" type="button" class="inline-flex items-center px-52 w-10 h-10  text-sm text-gray-500 rounded-lg md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mega-menu-full" aria-expanded="false">
         ...
         <ul class="hideOnMobile">
             <li>
                 <a href="home.html" class="underline-on-hover block py-2 px-3 text-gray-500 rounded md:hover:bg-transparent md:hover:text-gray-900  md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent text-sm mr-8"  aria-current="page">Home</a>
             </li>
             <li>
 ...
 <div class="  min-h-auto flex justify-center relative bg-gray-50   items-center px-4">
  ...
  <div class="max-w-3xl bg-gray-50 p-8  text-gray-800">
      <h2 class="text-xl font-mono mb-4 text-center text-black">ADMIN LOGIN</h2>
      <p class="text-xs font-serif text-gray-600 text-center">Welcome back, Admin! You are now logged in to the admin panel. &nbsp; &nbsp;&nbsp;</p><br>
      <form method="post" name="login">
          <div class="mb-4">
              <label for="email"  class="block text-sm font-serif text-gray-500">Email Address *</label><br>
              <div class="custom-input-wrapper">
  <input type="email" name="email" class="custom-input" placeholder="Email" aria-required="true" required >
</div>
          </div>
          <div class="mb-6">
          ...
          <p class="error text-red-600 text-xs"><?php echo isset($errors["credentials"]) ? $errors["credentials"] : ''; ?></p><br>
          <button type="submit"
